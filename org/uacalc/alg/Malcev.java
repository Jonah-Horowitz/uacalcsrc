...
*/
   ...
   * @param numThreads the number of threads to use in calculation (0=number of cores)
   */
  public static List<Term> jonssonTerms(SmallAlgebra alg, 
                                        boolean alvinVariant, ProgressReport report, int numThreads, int indicesPerChunk, String partialSave) {
    ...
    List<IntArray> sub = null;
    if ( numThreads==0 ) numThreads=Runtime.getRuntime().availableProcessors();
    if ( numThreads==1 ) {
    	sub = f2cubed.sgClose(gens, termMap, null, report);
    } else {
    	sub = f2cubed.sgCloseParallel(gens, termMap, null, report, numThreads, indicesPerChunk, partialSave);
    }
    if ( sub==null ) {
    	return null;
    }
